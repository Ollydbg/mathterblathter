	...
	public class MockRoomData
	{
		...
		public static RoomData ROOM_6 {
			get {
				var ret = new RoomData ();
				ret.Id = 106;
				ret.AsciiMap += "wccccccccccccccTcccTccc d cw";
				ret.AsciiMap += "w                          w";
				ret.AsciiMap += "w         2          2     w";
				ret.AsciiMap += "w                          w";
				ret.AsciiMap += "w                          w";
				...
				ret.AsciiMap += "w                          w";
				ret.AsciiMap += "w                          w";
				ret.AsciiMap += "fffffffffffffffssssfffffffff";
				ret.AsciiSpawnLookup['1'] = MockActorData.GROUNDED_RANGED_ENEMY;
				ret.AsciiSpawnLookup['s'] = MockActorData.SPIKES;
				ret.AsciiSpawnLookup['C'] = MockActorData.RANDOM_WEAPON_PICKUP;
				ret.AsciiSpawnLookup['T'] = new RoomData.AsciiPlacement(MockActorData.WALL_TURRET, Vector3.down);
		...
		public static RoomData ROOM_7 {
			get {
				var ret = new RoomData ();
				ret.Id = 107;
				ret.AsciiMap += "ccccccccccccccccccccccccccccccccccccccccccc";
				ret.AsciiMap += "w                                         w";
				ret.AsciiMap += "w                                         w";
				ret.AsciiMap += "w                                         w";
				ret.AsciiMap += "w                                         w";
				...
				ret.AsciiMap += "d                       L                 d";
				ret.AsciiMap += "                        1            2     ";
				ret.AsciiMap += "ffffffffffffffffffffffffffffffffffffffffffw";
		...
		public static RoomData ROOM_8 {
			get {
				...
				ret.AsciiMap += "d                                                  d";
				ret.AsciiMap += "                                              2     ";
				ret.AsciiMap += "ffffffffffffffffffffffff d ffffffffffffffffffffffffw";
